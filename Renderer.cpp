...
bool Renderer::Initialize(float screenWidth, float screenHeight) {
	...
	rWindow = SDL_CreateWindow("Final Gambit", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, static_cast<int>(rScreenWidth), static_cast<int>(rScreenHeight), SDL_WINDOW_OPENGL);
	if (!rWindow) {
